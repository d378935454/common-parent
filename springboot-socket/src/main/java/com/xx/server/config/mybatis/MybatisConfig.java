package com.xx.server.config.mybatis;
...
public class MybatisConfig {
	...
	public SqlSessionFactory sqlSessionFactory(DruidDataSource datasource, MybatisConfigurationProperties properties)
			throws Exception {
